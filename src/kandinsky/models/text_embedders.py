...
class Qwen2_5_VLTextEmbedder:
    ...
    def __init__(self, conf, device, text_token_padding=True):
...
class Kandinsky5TextEmbedder:
    def __init__(self, conf, device="cpu", text_token_padding=True):
        self.embedder = Qwen2_5_VLTextEmbedder(conf.qwen, device, text_token_padding)
...
def get_text_embedder(conf, device="cpu", text_token_padding=True):
    return Kandinsky5TextEmbedder(conf, device, text_token_padding)
